            ...
            <div class="card bg-primary text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="card-title mb-0">Moyenne</h6>
                            <h2 class="mb-0"><?= number_format($stats['avg_percentage'] ?? 0, 1) ?>%</h2>
                        </div>
        ...
        <div class="col-md-3">
            <div class="card bg-success text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="card-title mb-0">Meilleur score</h6>
                            <h2 class="mb-0"><?= number_format($stats['max_percentage'] ?? 0, 1) ?>%</h2>
                        </div>
        ...
        <div class="col-md-3">
            <div class="card bg-warning text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="card-title mb-0">Plus bas score</h6>
                            <h2 class="mb-0"><?= number_format($stats['min_percentage'] ?? 0, 1) ?>%</h2>
                        </div>
        ...
        <div class="col-md-3">
            <div class="card bg-info text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="card-title mb-0">Total passages</h6>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <strong><?= $result['score'] ?></strong> / <?= $result['total_points'] ?>
                                </td>
                                <td>
                                ...
                                <td><?= date('d/m/Y H:i', strtotime($result['submitted_at'])) ?></td>
                                <td>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h6>Étudiant: <?= htmlspecialchars($result['username']) ?></h6>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="mb-0">
                                                        ...
                                                        <span class="<?= $detail['is_correct'] ? 'text-success' : 'text-danger' ?>">
                                                            <?= $detail['points_earned'] ?> / <?= $detail['points_earned'] + ($detail['is_correct'] ? 0 : 1) ?>
                                                        </span>
                                                    </p>
                                                </div>
                                            </div>
